      ...
      <div className="relative">
        ...
        <Form {...form}>
          <motion.form 
            ...
            className="space-y-6 animate-fadeIn bg-gradient-to-b from-green-50 to-green-100 p-8 rounded-lg border border-green-200 shadow-md relative z-10 text-gray-800"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
